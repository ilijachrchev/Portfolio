...
const projects = [
  {
    ...
    role: 'Builder',
    shortDescription:
      'Multi-tenant B2B SaaS platform for AI-powered chatbot and email automation. Features a self hosted Socket.IO server, Clerk auth, Stripe billing, and an embeddable live chat widget.',
    description:
  ...
  },
  {
    ...
    role: 'Builder',
    shortDescription:
      'Forensic investigation assistant combining an OAK-D Pro Wide camera for real time depth mapping with Gemini-powered evidence analysis and Flare blockchain hashing for integrity verification.',
    description:
  ...
  },
  {
    ...
    shortDescription:
      'End to end underwater visibility prediction system placing 2nd at FAMNIT Hackathon 2026. Combines XGBoost environmental modeling, CLIP based image scoring, and a full custom sensor station design with active deployment planned.',
    description:
  ...
  },
  {
    ...
    role: 'Builder',
    shortDescription:
      'Job outreach tracker with skill gap analytics, a multiplatform internship scraper, a Chrome extension for LinkedIn outreach automation, and an email parser for tracking applications.',
    description:
      'Job outreach tracker with aggregate skill gap analytics, a multiplatform internship scraper, a Chrome extension for LinkedIn outreach automation, and an email parser for tracking application threads. Designed to surface patterns across outreach campaigns and highlight which skills appear consistently across job listings but are absent from your own profile.',
  ...
  },
  {
    ...
    shortDescription:
      'Real time port operations system modeling berth allocation, vessel queuing and traffic flow. Led a team of four to design and deliver the full system under realistic operational constraints.',
    description:
  ...
  },
  {
    ...
    role: 'Builder',
    shortDescription:
      'Graph based system for detecting wash trading behaviour in NFT markets, evaluating sequential, parallel and distributed processing strategies on real transaction data.',
    description:
