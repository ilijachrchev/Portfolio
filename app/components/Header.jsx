        ...
        initial={{scale: 0}} whileInView={{scale: 1}} transition={{duration: 0.8, type: 'spring', stiffness: 100}} >
            ...
            initial={{y: -20, opacity: 0}} whileInView={{y: 0, opacity: 1}}
             ...
             className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo '>
                Hi! I am Ilija Chrchev <Image src={assets.hand_icon} alt='' className='w-6' /></motion.h3>

            <motion.h1 initial={{y: -30, opacity: 0}} whileInView={{y: 0, opacity: 1}}
             transition={{duration: 0.8, delay: 0.5}}
             className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'>
                Computer Science Student in Slovenia, Koper
            </motion.h1>
            ...
            <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
                ...
                transition={{duration: 0.6, delay: 1.2}}
                 href="/Ilija_Chrchev_CV.pdf" download 
