...
export const DESKTOP_SPIDER_SCENES = [
  ...
  scene({
    ...
    range: [0.62, 0.12],
    anchor: [0.3, -0.12],
    curve: [[-0.08, 0.13], [0.08, 0.36], [0.77, 0.34], [1.08, 0.12]],
    rotation: [-24, 27],
    scale: [0.88, 0.99, 0.9],
  }),
  scene({
...
export const MOBILE_SPIDER_SCENES = [
  scene({
    ...
    strandFrom: -0.08,
    anchor: [0.16, -0.05],
    curve: [[0.02, 0.13], [0.04, 0.22], [0.12, 0.3], [0.24, 0.28]],
    rotation: [-16, 6],
    scale: [0.8, 0.86, 0.88],
  }),
  scene({
  ...
  scene({
    ...
    range: [0.68, 0.12],
    anchor: [0.76, -0.06],
    curve: [[1.08, 0.11], [0.98, 0.27], [0.46, 0.29], [-0.08, 0.13]],
    rotation: [25, -26],
