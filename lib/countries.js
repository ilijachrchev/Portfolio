export const COUNTRIES = [
  ...
  { name: 'Bahamas (the)', code: 'BS', emoji: '🇧🇸' },
  ...
  { name: 'Bolivia (Plurinational State of)', code: 'BO', emoji: '🇧🇴' },
  { name: 'Bonaire, Sint Eustatius and Saba', code: 'BQ', emoji: '🇧🇶' },
  ...
  { name: 'British Indian Ocean Territory (the)', code: 'IO', emoji: '🇮🇴' },
  ...
  { name: 'Cayman Islands (the)', code: 'KY', emoji: '🇰🇾' },
  { name: 'Central African Republic (the)', code: 'CF', emoji: '🇨🇫' },
  { name: 'Chad', code: 'TD', emoji: '🇹🇩' },
  { name: 'Chile', code: 'CL', emoji: '🇨🇱' },
  { name: 'China', code: 'CN', emoji: '🇨🇳' },
  { name: 'Christmas Island', code: 'CX', emoji: '🇨🇽' },
  { name: 'Cocos (Keeling) Islands (the)', code: 'CC', emoji: '🇨🇨' },
  { name: 'Colombia', code: 'CO', emoji: '🇨🇴' },
  { name: 'Comoros (the)', code: 'KM', emoji: '🇰🇲' },
  { name: 'Congo (the Democratic Republic of the)', code: 'CD', emoji: '🇨🇩' },
  { name: 'Congo (the)', code: 'CG', emoji: '🇨🇬' },
  { name: 'Cook Islands (the)', code: 'CK', emoji: '🇨🇰' },
  ...
  { name: 'Dominican Republic (the)', code: 'DO', emoji: '🇩🇴' },
  ...
  { name: 'Falkland Islands (the) [Malvinas]', code: 'FK', emoji: '🇫🇰' },
  { name: 'Faroe Islands (the)', code: 'FO', emoji: '🇫🇴' },
  ...
  { name: 'French Southern Territories (the)', code: 'TF', emoji: '🇹🇫' },
  { name: 'Gabon', code: 'GA', emoji: '🇬🇦' },
  { name: 'Gambia (the)', code: 'GM', emoji: '🇬🇲' },
  ...
  { name: 'Holy See (the)', code: 'VA', emoji: '🇻🇦' },
  ...
  { name: 'Korea (the Democratic People\'s Republic of)', code: 'KP', emoji: '🇰🇵' },
  { name: 'Korea (the Republic of)', code: 'KR', emoji: '🇰🇷' },
  { name: 'Kuwait', code: 'KW', emoji: '🇰🇼' },
  { name: 'Kyrgyzstan', code: 'KG', emoji: '🇰🇬' },
  { name: 'Lao People\'s Democratic Republic (the)', code: 'LA', emoji: '🇱🇦' },
  ...
  { name: 'Marshall Islands (the)', code: 'MH', emoji: '🇲🇭' },
  ...
  { name: 'Moldova (the Republic of)', code: 'MD', emoji: '🇲🇩' },
  ...
  { name: 'Russian Federation (the)', code: 'RU', emoji: '🇷🇺' },
  { name: 'Rwanda', code: 'RW', emoji: '🇷🇼' },
  { name: 'Saint Barthélemy', code: 'BL', emoji: '🇧🇱' },
  { name: 'Saint Helena, Ascension and Tristan da Cunha', code: 'SH', emoji: '🇸🇭' },
  { name: 'Saint Kitts and Nevis', code: 'KN', emoji: '🇰🇳' },
  { name: 'Saint Lucia', code: 'LC', emoji: '🇱🇨' },
  { name: 'Saint Martin (French part)', code: 'MF', emoji: '🇲🇫' },
  ...
  { name: 'Sint Maarten (Dutch part)', code: 'SX', emoji: '🇸🇽' },
  ...
  { name: 'Turks and Caicos Islands (the)', code: 'TC', emoji: '🇹🇨' },
  { name: 'Tuvalu', code: 'TV', emoji: '🇹🇻' },
  { name: 'Uganda', code: 'UG', emoji: '🇺🇬' },
  { name: 'Ukraine', code: 'UA', emoji: '🇺🇦' },
  { name: 'United Arab Emirates (the)', code: 'AE', emoji: '🇦🇪' },
  { name: 'United Kingdom of Great Britain and Northern Ireland (the)', code: 'GB', emoji: '🇬🇧' },
  { name: 'United States Minor Outlying Islands (the)', code: 'UM', emoji: '🇺🇲' },
  { name: 'United States of America (the)', code: 'US', emoji: '🇺🇸' },
  { name: 'Uruguay', code: 'UY', emoji: '🇺🇾' },
  { name: 'Uzbekistan', code: 'UZ', emoji: '🇺🇿' },
  { name: 'Vanuatu', code: 'VU', emoji: '🇻🇺' },
  { name: 'Venezuela (Bolivarian Republic of)', code: 'VE', emoji: '🇻🇪' },
  ...
  { name: 'Eswatini (Swaziland)', code: 'SZ', emoji: '🇸🇿' },
